      ...
      <section className="py-24">
        <div className="container mx-auto px-6">
          <div className="grid gap-8 md:grid-cols-2 lg:grid-cols-3">
            {posts.map((post, i) => {
              const isPublished = post.slug === 'radiator-cold-at-bottom' || post.slug === 'boiler-repair-vs-replacement' || post.slug === 'landlord-gas-safety-check' || post.slug === 'burst-pipe-what-to-do' || post.slug === 'check-gas-safe-registered';
