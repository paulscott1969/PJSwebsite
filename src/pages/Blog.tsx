            ...
            <div className="grid gap-8 md:grid-cols-2 lg:grid-cols-3">
              {posts.map((post, i) => (
                ...
                >
                  ...
                  <h2 className="mb-3 text-xl font-black leading-tight text-gray-900 group-hover:text-blue-600 transition-colors">
                    {post.title}
                  </h2>
                  ...
                  <div className="mt-8 flex items-center gap-3 text-xs font-bold text-gray-400">
